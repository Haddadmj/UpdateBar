...
#   brew tap <you>/tap && brew install --cask updatebar
cask "updatebar" do
  version "0.1.0"
  sha256 :no_check # replace with the DMG's shasum -a 256 once published

  url "https://github.com/<you>/UpdateBar/releases/download/v#{version}/UpdateBar.dmg"
  name "UpdateBar"
  desc "Menu-bar aggregator of pending updates across package managers and app stores"
  homepage "https://github.com/<you>/UpdateBar"
